...
if("FALSE" STREQUAL "TRUE")
  set(turtlebot_follower_SOURCE_PREFIX /home/dsp/dsp_ws/src/turtlebot/turtlebot_apps/turtlebot_follower)
  set(turtlebot_follower_DEVEL_PREFIX /home/dsp/dsp_ws/devel)
  ...
  set(turtlebot_follower_INSTALL_PREFIX /home/dsp/dsp_ws/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlebot_follower' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dsp/dsp_ws/install/${idir}'.  Ask the maintainer 'Daniel Stonier <stonier@rnd.yujinrobot.com>' to fix it.")
    endif()
