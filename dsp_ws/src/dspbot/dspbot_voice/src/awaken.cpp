...
const char *lgi_param = "appid = 5c9b1764,work_dir = .";
...
int main(int argc, char* argv[])
{
	...
	ros::Publisher pub3 = nd.advertise<std_msgs::Int32>("/voice/xf_asr_topic",3);
	
  	ros::Rate loop_rate(10);
  	std_msgs::String msg;
  	msg.data=mydata;

	std_msgs::Int32 asrmsg;
	asrmsg.data=1;			
