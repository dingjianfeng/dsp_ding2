...
void asrProcess()
{
    ...
    const char* login_params = "appid = 5c9b1764, work_dir = .";
...
int main(int argc, char* argv[])
{
    ...
    ros::init(argc, argv, "xf_asr_online_node");
    ros::NodeHandle nd;
 
    ros::Subscriber sub = nd.subscribe("/voice/xf_asr_topic",1000, asrCallBack);
