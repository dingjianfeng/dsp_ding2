...
def callback(data):
  ...
  if data.data=='pick':
        ...
        buffer_write_2=bytearray("\x55\x55\x1A\x03\x07\xE8\x03\x15\x08\x07\x16\x19\x09\x17\x4C\x04\x18\x08\x07\x19\x08\x07\x1A\xD0\x07\x1E\x20\x03")
        ser.write(buffer_write_2)    
        rospy.sleep(2)
        buffer_write_3=bytearray("\x55\x55\x1A\x03\x07\xE8\x03\x15\x08\x07\x16\x19\x09\x17\x4C\x04\x18\x08\x07\x19\x08\x07\x1A\xD0\x07\x1E\xD6\x06")
