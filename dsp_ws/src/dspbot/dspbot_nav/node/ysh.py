...
###############################################################
    ...
    def __init__(self):
        ...
        locations['出发点'] = Pose(Point(0.361, 0.015, 0.000), Quaternion(0.000, 0.000, 0.000, 1.000))
        locations['厨房'] = Pose(Point(1.778, 0.288, 0.000), Quaternion(0.000, 0.000, 0.668, 0.744))
        locations['卧室'] = Pose(Point(1.490, 4.225, 0.000), Quaternion(0.000, 0.000, 0.035, 0.999))
        locations['客厅'] = Pose(Point(-0.315, 4.321, 0.000), Quaternion(0.000, 0.000, -0.676, 0.737))      
