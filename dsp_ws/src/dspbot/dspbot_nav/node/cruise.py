...
class NavTest():
    def __init__(self):
        ...
        locations['kitchen'] = Pose(Point(0.917, -0.654, 0.000), Quaternion(0.000, 0.000, -0.684, 0.729))
        locations['bedroom'] = Pose(Point(-1.041, -0.281, 0.000), Quaternion(0.000, 0.000, -0.720, 0.694))
        locations['hall'] = Pose(Point(-0.450, 0.831, 0.000), Quaternion(0.000, 0.000, 0.999, -0.041))
	locations['bedroom'] = Pose(Point(1.172, 0.868, 0.000), Quaternion(0.000, 0.000, -0.051, 0.999))
#        locations['kitchen'] = Pose(Point(0.955, -0.264, 0.000), Quaternion(0.000, 0.000, -0.687, 0.726))        
