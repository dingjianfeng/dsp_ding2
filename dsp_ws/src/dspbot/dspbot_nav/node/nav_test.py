...
class NavTest():
    def __init__(self):
        ...
        locations['A'] = Pose(Point(3.353, 0.521, 0.000), Quaternion(0.000, 0.000, 0.000, 1.000))
        locations['B'] = Pose(Point(6.177, 0.908, 0.000), Quaternion(0.000, 0.000, -0.179, 0.984))
        locations['C'] = Pose(Point(8.828, 0.405, 0.000), Quaternion(0.000, 0.000, 0.000, 1.000))
#        locations['D'] = Pose(Point(8.828, 0.049, 0.000), Quaternion(0.000, 0.000, 0.000, 1.000))
        locations['D'] = Pose(Point(14.446, 0.785, 0.000), Quaternion(0.000, 0.000, -0.093, 0.996))
