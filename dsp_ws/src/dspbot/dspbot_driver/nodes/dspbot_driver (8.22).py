...
class BaseController:
    def __init__(self, arduino, base_frame):
        ...
        rospy.Subscriber("charge",          String, self.AutoChargeCallBack)
        rospy.Subscriber("updown",          String, self.AutoUpDownCallBack)
    ...
    def poll(self):
	    ...
	    #print "dright:  dleft: ",dright,dleft
            ...
            if not self.stopped:
 	        rospy.loginfo("left_enc: " + str(self.v_left)+"right_enc: " + str(self.v_right))
    ...
    def AutoChargeCallBack(self,msg):
	if msg.data == 'startcharge':
	   self.arduino.port.write('o' + '\r')
           rospy.loginfo("CMD:StartCharge...")
	if msg.data == 'stopscan':
	   self.arduino.port.write('stopscan' + '\r')
	   rospy.loginfo("CMD:Stopscan...")
        if msg.data == 'stopcharge':
	   self.arduino.port.write('stopcharge' + '\r')
	   rospy.loginfo("CMD:StopCharge...")
    def AutoUpDownCallBack(self,msg):
	if msg.data == 'up':
	   self.arduino.port.write('l 1 10000 -3500 ' + '\r') 
	   rospy.loginfo("CMD:Start UP...")  
	if msg.data == 'down':
	   self.arduino.port.write('l 1 10000 3500 ' + '\r')   
	   rospy.loginfo("CMD:Start DOWN...")
class ArduinoROS():
    def __init__(self):
	...
	rospy.Subscriber("top_down",          String, self.AutoTopDownCallBack)
    ...
    def AutoTopDownCallBack(self,msg):
	if msg.data == 'up':
	   self.controller.port.write('l 1 10000 -3500 ' + '\r') 
	   rospy.loginfo("CMD:Start UP...")  
	if msg.data == 'down':
	   self.controller.port.write('l 1 10000 3500 ' + '\r')   
	   rospy.loginfo("CMD:Start DOWN...")
