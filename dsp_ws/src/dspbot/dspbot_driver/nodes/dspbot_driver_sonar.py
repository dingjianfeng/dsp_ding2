...
class BaseController:
    def __init__(self, arduino, base_frame):
        ...
        self.fRangerPub = rospy.Publisher('Franger', Int16, queue_size=5)
        self.bRangerPub = rospy.Publisher('Branger', Int16, queue_size=5)
    ...
    def poll(self):
        ...
        if now > self.t_next:
            try:
                r1, r2 = self.arduino.ping()
                #rospy.loginfo("r1: " + str(r1)+"r2: " + str(r2))
                self.fRangerPub.publish(r1)
                self.bRangerPub.publish(r2)
            except:
