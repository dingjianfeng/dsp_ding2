...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_3I.pack(_x.boundary.header.seq, _x.boundary.header.stamp.secs, _x.boundary.header.stamp.nsecs))
      ...
      _x = self
      buff.write(_struct_3I.pack(_x.start_point.header.seq, _x.start_point.header.stamp.secs, _x.start_point.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3d.pack(_x.start_point.point.x, _x.start_point.point.y, _x.start_point.point.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.boundary.header.seq, _x.boundary.header.stamp.secs, _x.boundary.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.start_point.header.seq, _x.start_point.header.stamp.secs, _x.start_point.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.start_point.point.x, _x.start_point.point.y, _x.start_point.point.z,) = _struct_3d.unpack(str[start:end])
      return self
