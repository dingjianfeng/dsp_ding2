...
"""autogenerated by genpy from blinky/FaceActionFeedback.msg. Do not edit."""
import sys
...
class FaceActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "blinky/FaceActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','blinky/FaceFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FaceActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = blinky.msg.FaceFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = blinky.msg.FaceFeedback()
