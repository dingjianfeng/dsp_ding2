...
"""autogenerated by genpy from blinky/FaceActionResult.msg. Do not edit."""
import sys
...
class FaceActionResult(genpy.Message):
  _md5sum = "14b0a30c3c68646f63600035358ab615"
  _type = "blinky/FaceActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','blinky/FaceResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FaceActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = blinky.msg.FaceResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = blinky.msg.FaceResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.result.choice = str[start:end].decode('utf-8')
      else:
        self.result.choice = str[start:end]
      return self
