...
"""autogenerated by genpy from blinky/FaceAction.msg. Do not edit."""
import sys
...
class FaceAction(genpy.Message):
  _md5sum = "70ce073bfa36fac8b602f0ae1fa0b26e"
  _type = "blinky/FaceAction"
...
"""
  ...
  _slot_types = ['blinky/FaceActionGoal','blinky/FaceActionResult','blinky/FaceActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FaceAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = blinky.msg.FaceActionGoal()
      if self.action_result is None:
        self.action_result = blinky.msg.FaceActionResult()
      if self.action_feedback is None:
        self.action_feedback = blinky.msg.FaceActionFeedback()
    else:
      self.action_goal = blinky.msg.FaceActionGoal()
      self.action_result = blinky.msg.FaceActionResult()
      self.action_feedback = blinky.msg.FaceActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.display_type
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.h1_text
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.h2_text
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.question
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.action_goal.goal.choices)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.choices:
        length = len(val1)
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_result.result.choice
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.display_type = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.display_type = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.h1_text = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.h1_text = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.h2_text = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.h2_text = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.question = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.question = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.choices = []
      for i in range(0, length):
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.action_goal.goal.choices.append(val1)
      _x = self
      start = end
      end += 12
      ...
      if python3:
        self.action_result.result.choice = str[start:end].decode('utf-8')
      else:
        self.action_result.result.choice = str[start:end]
      _x = self
      start = end
      end += 12
